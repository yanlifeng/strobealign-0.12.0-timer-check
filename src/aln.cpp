...
void align_PE_read(
    ...
    static thread_local double con_strobe_time = 0;
    static thread_local double nam_time = 0;
    static thread_local double resue_time = 0;
    static thread_local double sort_time = 0;
    static thread_local double extend_time = 0;
    ...
    if(cnt % 10000 == 0) {
        ...
        ss << mainthreadid;
        unsigned long mainthreadidvalue = std::stoul(ss.str());
        fprintf(stderr, "align_PE [%lld] %lf %lf %lf %lf %lf\n", mainthreadidvalue, con_strobe_time, nam_time, resue_time, sort_time, extend_time);
    }
